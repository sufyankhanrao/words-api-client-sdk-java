...
| `Results` | [`List<WordDetails>`](../../doc/models/word-details.md) | Optional | This field contains detailed information of the word. | List<WordDetails> getResults() | setResults(List<WordDetails> results) |
